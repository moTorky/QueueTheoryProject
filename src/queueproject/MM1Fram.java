 ...
 * @author power
 */
public class MM1Fram extends javax.swing.JFrame {

    private static final DecimalFormat df = new DecimalFormat("0.00");
    private DD1kFram parent;
    public MM1Fram(DD1kFram parent) {
        initComponents();
        this.parent = parent;
    }
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(29, 29, 29)))
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txt_Mu, javax.swing.GroupLayout.PREFERRED_SIZE, 106, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        queueMM1 mM1 = new queueMM1(Lambda, Mu);
        
        txt_L.setText(df.format(mM1.getL())+"");
        txt_LQ.setText(df.format(mM1.getLq())+"");
        txt_W.setText(df.format(mM1.getW())+"");
        txt_WQ.setText(df.format(mM1.getWq())+"");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MM1Fram.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
